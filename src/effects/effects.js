...
module.exports.lark = (imageData) => applyInstagramFilter('lark', imageData.data);
module.exports.reyes = (imageData) => applyInstagramFilter('reyes', imageData.data);
module.exports.juno = (imageData) => applyInstagramFilter('juno', imageData.data);
module.exports.slumber = (imageData) => applyInstagramFilter('slumber', imageData.data);
module.exports.crema = (imageData) => applyInstagramFilter('crema', imageData.data);
module.exports.ludwig = (imageData) => applyInstagramFilter('ludwig', imageData.data);
module.exports.aden = (imageData) => applyInstagramFilter('aden', imageData.data);
module.exports.perpetua = (imageData) => applyInstagramFilter('perpetua', imageData.data);
module.exports.amaro = (imageData) => applyInstagramFilter('amaro', imageData.data);
module.exports.mayfair = (imageData) => applyInstagramFilter('mayfair', imageData.data);
module.exports.rise = (imageData) => applyInstagramFilter('rise', imageData.data);
module.exports.hudson = (imageData) => applyInstagramFilter('hudson', imageData.data);
module.exports.valencia = (imageData) => applyInstagramFilter('valencia', imageData.data);
module.exports.xpro2 = (imageData) => applyInstagramFilter('xpro2', imageData.data);
module.exports.sierra = (imageData) => applyInstagramFilter('sierra', imageData.data);
module.exports.willow = (imageData) => applyInstagramFilter('willow', imageData.data);
module.exports.lofi = (imageData) => applyInstagramFilter('lofi', imageData.data);
module.exports.earlybird = (imageData) => applyInstagramFilter('earlybird', imageData.data);
module.exports.brannan = (imageData) => applyInstagramFilter('brannan', imageData.data);
...
module.exports.hefe = (imageData) => applyInstagramFilter('hefe', imageData.data);
module.exports.nashville = (imageData) => applyInstagramFilter('nashville', imageData.data);
module.exports.sutro = (imageData) => applyInstagramFilter('sutro', imageData.data);
module.exports.toaster = (imageData) => applyInstagramFilter('toaster', imageData.data);
module.exports.walden = (imageData) => applyInstagramFilter('walden', imageData.data);
module.exports.nineteenSeventySeven = (imageData) => applyInstagramFilter('nineteenSeventySeven', imageData.data);
module.exports.kelvin = (imageData) => applyInstagramFilter('kelvin', imageData.data);
